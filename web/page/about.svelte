<div>
    ...
    <p>
        ...
        in being ouw twue selves and inspiwing othews to do the same. By shouwing
        ouw authentic selves, we hope to cweate a space whewe evewyone feels welcome
        and loved. ♥～(‘▽^人) Join us on this exciting adventuwe as we expwore new
        ideaws and cweate magical moments togethew! Thank you fow being pawt of ouw
        stowy!
    </p>
    <p>
        please do not take this seriously, we are just having fun with this
        text. If you have any questions or concerns, please contact us at the
        email address below. Thank you! ٩(◕‿◕｡)۶
    </p>
    <p>
        This project is open source and you can find the source code on <a
            href="https://github.com/Masterjoona/pawste "
            target="_blank">GitHub</a
        >! The backend (Joona) is written in Go and the frontend (Taro) is
        written in Svelte.
    </p>
    <p>
